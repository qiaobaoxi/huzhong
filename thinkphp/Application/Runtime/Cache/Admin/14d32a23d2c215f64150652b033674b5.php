...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><span>会计服务产品</span></div>
        </div>
               ...
               <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th>业务左边栏：</th>
                                <td><textarea name="article1" class="common-textarea" id="content2" cols="10" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
                            <tr>
                                <th>业务右边栏：</th>
                                <td><textarea name="article2" class="common-textarea" id="content1" cols="10" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
                            <tr>
                                <th>特色左边栏：</th>
                                <td><textarea name="article3" class="common-textarea" id="content3" cols="10" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
                            <tr>
                                <th>特色右边栏：</th>
                                <td><textarea name="article4" class="common-textarea" id="content4" cols="10" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
