...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><span>会计典型案例添加</span></div>
        </div>
                ...
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th>案例公司：</th>
                                <td><input class="bigtext" name="leftContent" size="50" type="text"></td>
                            </tr>
                           <tr>
                                <th>审核内容：</th>
                                <td><input class="text" name="rightContent" size="50"  type="text"></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
