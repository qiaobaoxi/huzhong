                ...
                <li>
                 ...
                 <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <!--<li><a href="/thinkphp/index.php/Admin/Kuaiji/shuiwufuwuchanpin"><i class="icon-font">&#xe033;</i>税务服务产品</a></li>-->
                   </ul>
                </li>
                 <li>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/thinkphp/index.php/Admin/Kuaiji/kuaijidianxinganliAdd"><i class="icon-font"></i>新增内容</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	                            ...
	                            <td>
	                                <a class="link-update" href="/thinkphp/index.php/Admin/Kuaiji/kuaijidianxinganliEdit?id=<?php echo ($vo["id"]); ?>">修改</a>
	                                <a class="link-del" href="/thinkphp/index.php/Admin/Kuaiji/kuaijidianxinganliDel?id=<?php echo ($vo["id"]); ?>" onclick="return confirm('你确定要删除吗')" >删除</a>
	                            </td>
